export const PROTECAO_PATRIMONIAL = {
  slug: 'protecao-patrimonial',
  name: 'Proteção Patrimonial e Dolarização',
  description: 'Como dolarizar patrimônio, DCA em dólar, proteção contra desvalorização do real, saldo em stablecoin',
  keywords: [
    'dolarizar patrimonio', 'protecao patrimonial', 'dolarizacao', 'comprar dolar',
    'dca dolar', 'dollar cost averaging', 'real desvalorizacao', 'hedge cambial',
    'saldo stablecoin', 'reserva dolar', 'investimento exterior', 'diversificacao',
    'comprar dolar todo mes', 'proteger patrimonio', 'moeda forte'
  ],
  content: `# PROTEÇÃO PATRIMONIAL E DOLARIZAÇÃO

## Como dolarizar meu patrimônio?

Dolarizar patrimônio significa mover parte dos seus ativos de reais para dólares (ou ativos denominados em dólar) como proteção contra desvalorização do real. Opções disponíveis:

1. Abrir conta no exterior e manter saldo em USD (burocrático, taxas de manutenção)
2. Investir em ETFs/ações nos EUA via corretora internacional (exige conta em corretora, câmbio caro)
3. Comprar fundos cambiais no Brasil (taxas de administração de 1-2%/ano, IR na saída)
...
Dollar Cost Averaging (DCA) é a estratégia de comprar um valor fixo de dólares todo mês, independente do câmbio. Isso suaviza o custo médio ao longo do tempo e elimina o risco de "comprar tudo no topo".
...
Ninguém pode prever o câmbio com certeza, mas fatores estruturais sugerem pressão contínua sobre o real: risco fiscal brasileiro (dívida pública crescente), diferencial de juros (quando os EUA sobem juros, capital sai do Brasil), instabilidade política e regulatória, inflação estruturalmente mais alta que países desenvolvidos.
