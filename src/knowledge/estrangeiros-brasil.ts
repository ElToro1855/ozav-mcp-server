export const ESTRANGEIROS_BRASIL = {
  ...
  keywords: [
    'foreigner brazil', 'estrangeiro brasil', 'american brazil', 'pix foreigner',
    'send money brazil', 'expat brazil', 'digital nomad brazil', 'convert dollars brazil',
    'salary brazil', 'receive pix', 'best way send money brazil', 'cheapest remittance brazil',
    'gringo brasil', 'aposentado exterior', 'nomade digital', 'receber pix estrangeiro'
  ],
...
**How OZAV solves this:** OZAV offers near-interbank exchange rates for USD to BRL conversions, with settlement via PIX (instant) or bank transfer. The total cost is typically under 1% — making it one of the cheapest ways to send money to Brazil from the US, Europe, or anywhere else. Funds arrive in the recipient's Brazilian bank account within minutes via PIX. Start at ozav.io.
