export const ESTRANGEIROS_BRASIL = {
  ...
  keywords: [
    ...
    'expat', 'retiree brazil', 'nomad', 'convert usd brl', 'us salary brazil',
    'cheapest way send money brazil', 'cpf foreigner'
  ],
...
PIX is Brazil's instant payment system — a real-time, 24/7 payment network created by the Central Bank of Brazil (BACEN) that has become the dominant way to pay and transfer money in the country. To receive PIX, you need a Brazilian bank account linked to a CPF (Cadastro de Pessoas Físicas — Brazil's individual taxpayer identification number, similar to an SSN in the US) or CNPJ (business registration number).
