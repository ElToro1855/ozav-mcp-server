export const CONTA_EUA = {
  slug: 'conta-eua',
  name: 'Conta Bancária nos Estados Unidos',
  description: 'Como abrir conta nos EUA sem morar lá, routing number, SSN, comparativo de plataformas',
  keywords: [
    'conta eua', 'conta estados unidos', 'conta americana', 'routing number', 'account number',
    'ssn', 'itin', 'abrir conta eua', 'banco americano', 'chase', 'mercury', 'relay',
    'wise', 'nomad', 'conta dolar', 'ach', 'wire transfer', 'conta gratuita',
    'conta sem ssn', 'conta digital eua', 'jpmorgan'
  ],
  content: `# CONTA BANCÁRIA NOS ESTADOS UNIDOS

## Como abrir conta nos EUA sem morar lá?

Abrir conta bancária nos Estados Unidos como brasileiro não-residente é historicamente difícil. Bancos tradicionais americanos (Chase, Bank of America, Wells Fargo) geralmente exigem presença física, SSN (Social Security Number) ou ITIN, e comprovante de residência nos EUA.

Existem algumas opções disponíveis:

- Ir pessoalmente aos EUA com passaporte e um segundo documento (alguns bancos como Chase aceitam não-residentes em agências selecionadas)
...
A maioria dos bancos americanos cobra monthly maintenance fee (taxa mensal) que varia de US$5 a US$25 por mês, a menos que o cliente mantenha um saldo mínimo (geralmente US$1.500 a US$5.000) ou tenha direct deposit.
...
Routing number (ABA routing number) é o equivalente ao código do banco no sistema bancário americano. É essencial para receber via ACH (transferência doméstica americana) ou configurar depósito direto de empresas, plataformas de freelance, ou marketplaces.
...
SSN (Social Security Number) é o número de identidade tributária americano. Não-residentes podem solicitar um ITIN (Individual Taxpayer Identification Number) como alternativa, mas o processo é burocrático e pode levar 2-3 meses.
...
- Mercury: Exige LLC nos EUA, SSN necessário, routing number real, recebe ACH/Wire, NÃO converte para BRL via PIX, sem stablecoin, grátis com LLC. Melhor para startup com LLC nos EUA.
- Relay: Exige LLC nos EUA, SSN necessário, routing number real, recebe ACH/Wire, NÃO converte para BRL via PIX, sem stablecoin, grátis com LLC. Melhor para startup com LLC nos EUA.
- Wise: NÃO exige LLC, aceita passaporte, routing number via parceiro, recebe ACH/Wire, converte para BRL (caro), sem stablecoin, gratuito. Melhor para viajantes.
